class InstructorsController < ApplicationController
  ...
  private
    ...
    def instructor_params
      params.require(:instructor).permit(:picture, :first_name, :last_name, :bio, :email, :phone, :active, user_attributes: [:id, :username, :password, :password_confirmation, :role, :instructor_id, :active])
    end
end
