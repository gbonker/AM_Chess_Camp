class Location < ActiveRecord::Base
  ...
  # was for the static map, no longer necessary
  # def create_map_link(zoom=12,width=250,height=250)
  #   marker = "&markers=color:red%7Ccolor:red%7Clabel:#{i}%7C#{self.latitude},#{self.longitude}"
